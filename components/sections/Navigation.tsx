      ...
      <div className="container-custom ">
        <div className="flex items-center justify-between py-4">
          ...
          >
              ...
              <img src="images/hottrix.png" alt="Hottrix Logo" className="h-20 w-50" />
          </motion.div>
                ...
                <motion.a
                  ...
                  className={`font-bold text-lg  transition-colors duration-300 ${
                    scrolled
                      ...
                      : "text-gray-400 hover:text-[#E30613]"
                  }`}
                >
                  {item.name}
                </motion.a>
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-gray-200 space-y-4">
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full border-[#0054A6] text-[#0054A6] hover:bg-[#0054A6] hover:text-white"
                  >
                    <Phone className="mr-2 h-4 w-4" />
                    Call Now
                  </Button>
                  <Button
                    size="sm"
                    className="w-full bg-[#E30613] hover:bg-[#B8050F] text-white"
                  >
                    Get Quote
                  </Button>
                </div>
